...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    g.bench_function("naive_line_by_line_dummy", |b| {
        b.iter(|| naive_line_by_line_dummy_benchmark(bytes.as_slice()))
    });
    ...
    g.bench_function("naive_line_by_line for 38049 lines", |b| {
        b.iter(|| naive_line_by_line_benchmark(bytes.as_slice()))
    });
    ...
    g.bench_function("improved_impl_v2_benchmark for 38049 lines", |b| {
