...
hyperfine --warmup 1 --runs 4 --export-markdown dummy.md "${run_app} naive_line_by_line_dummy" \
  "${run_app} parse_large_chunks_as_bytes_dummy" \
  "${run_app} parse_large_chunks_as_i64_dummy" \
  "${run_app} parse_large_chunks_simd_dummy"
