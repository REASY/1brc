...
hyperfine --warmup 1 --runs 4 --export-markdown dummy.md "${run_app_1} naive_line_by_line_dummy" \
  "${run_app_1} parse_large_chunks_as_bytes_dummy" \
  "${run_app_1} parse_large_chunks_as_i64_dummy" \
  "${run_app_1} parse_large_chunks_simd_dummy"
